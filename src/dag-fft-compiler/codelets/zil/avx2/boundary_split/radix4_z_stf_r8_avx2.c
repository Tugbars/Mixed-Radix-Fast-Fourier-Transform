 ...
 * stf@r4 (ZTURN-S RADIX-4 terminator: 4 section taps, ONE 64-B record per tap, NO load shuffles, packed w^1 truncated squaring tree, REINT drev-comb stores; OLs = count = N/4), fwd.
...
/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 4 --zp-stf --zp-r0 8 --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=stf radix=4 dir=fwd isa=avx2 r0=8 (ZTURN-S sectioned geometry)
