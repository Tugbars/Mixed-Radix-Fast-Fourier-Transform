...
/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 4 --zp-dtso --zp-r0 4 --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=dtso radix=4 dir=fwd isa=avx2 r0=4 (ZTURN-S sectioned geometry)
...
void radix4_z_dtso_r4_fwd_avx2(
    ...
    size_t Ls, size_t Gs, size_t OLs, size_t OGs, size_t count)
{
    ...
    for (size_t k = 0; k + 4 <= count; k += 4) {
        ...
        const __m256d t28 = _mm256_loadu_pd(&tw_re[2*(size_t)kn + 0]);
        const __m256d t30 = _mm256_loadu_pd(&tw_re[2*(size_t)kn + 4]);
