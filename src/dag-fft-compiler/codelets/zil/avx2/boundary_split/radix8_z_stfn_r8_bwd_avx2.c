 ...
 * stfbn (NATURAL-ORDER ZTURN-S bwd terminator: NATURAL z in, read at kn = 4*rho[k/4] via the tw_im-carried table, IDFT + POST conj-w^1 at k, section-record stores at k), bwd.
...
/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 8 --zp-stfbn --zp-r0 8 --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=stfn radix=8 dir=bwd isa=avx2 r0=8 (ZTURN-S sectioned geometry)
...
void radix8_z_stfn_r8_bwd_avx2(
