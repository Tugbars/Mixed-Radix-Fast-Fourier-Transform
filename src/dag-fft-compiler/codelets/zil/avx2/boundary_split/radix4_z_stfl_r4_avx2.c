...
/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 4 --zp-stfl --zp-r0 4 --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=stfl radix=4 dir=fwd isa=avx2 r0=4 (ZTURN-S sectioned geometry)
...
void radix4_z_stfl_r4_fwd_avx2(
