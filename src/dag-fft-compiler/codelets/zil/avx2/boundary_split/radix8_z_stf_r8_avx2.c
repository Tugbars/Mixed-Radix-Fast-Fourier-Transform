 ...
 * stf (ZTURN-S terminator: 4 section taps, 2 consecutive records = 128 B contiguous per tap, NO load shuffles, packed w^1 squaring tree, REINT drev-comb stores), fwd.
...
/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 8 --zp-stf --zp-r0 8 --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=stf radix=8 dir=fwd isa=avx2 r0=8 (ZTURN-S sectioned geometry)
