...
/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 4 --zp-stfn --zp-r0 8 --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=stfn radix=4 dir=fwd isa=avx2 r0=8 (ZTURN-S sectioned geometry)
...
void radix4_z_stfn_r8_fwd_avx2(
