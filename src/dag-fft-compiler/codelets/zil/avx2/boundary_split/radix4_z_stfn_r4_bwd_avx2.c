...
/* ===================== PROVENANCE =====================
 * Generated by: gen_radix.exe 4 --zp-stfbn --zp-r0 4 --isa avx2 --uarch raptor_lake_avx2 --emit-c
 * Env overrides: (none)
 * Family: zsplit-pipeline
 * kind=stfn radix=4 dir=bwd isa=avx2 r0=4 (ZTURN-S sectioned geometry)
...
void radix4_z_stfn_r4_bwd_avx2(
